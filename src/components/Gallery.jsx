...
const Gallery = () => {
  ...
  const imageData = [
    {
      alt: 'image1',
      url: 'https://images.pexels.com/photos/4720236/pexels-photo-4720236.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    },
    {
        alt: 'image2',
        url: "https://images.pexels.com/photos/5383777/pexels-photo-5383777.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    },
    {
        alt: 'image3',
        url: "https://images.pexels.com/photos/4662339/pexels-photo-4662339.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    },
    {
        alt: 'image4',
        url: "https://images.pexels.com/photos/5150474/pexels-photo-5150474.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    },
  ...
  return (
    <Stack
      ...
      display={{ xs: 'flex' }}
    >
      <Box component="section" pb={3}>
        <Typography variant="h4" align="center" style={{backgroundColor:"black" ,color:"white"}}>
          THE MUSCLE BUILDER GALLERY
        </Typography>
        <Typography variant="h5" align="center" py={1}>
          WE RESPECTS YOUR HEALTH
        </Typography>
        <Typography align="center">
         THIS IS OUR SHORT GALLERY OF OUR GYM
        </Typography>
      </Box>
      ...
      <Box maxWidth={700} width="100%">
        <Carousel
          ...
          showArrows={false}
          autoPlay={true}
          interval={1000} // Set the interval duration to 1 second (1000 milliseconds)
          infiniteLoop={true}
          selectedItem={imageData[currentIndex]}
          onChange={handleChange}
          className="carousel-container"
